...
python abs_pytorch1_both_batch_inner_both_with_prune.py --result_filepath=./results/results.txt --arch=MobileNet --examples_dirpath=./data/asl_exray/ --model_filepath=model_files/model_semtrain_MobileNet_asl_A_last.th --scratch_dirpath=./scratch/ --num_classes=29 --input_width=200 --input_height=200 --channels=3 --img_pad=0 --filter_shape=12
